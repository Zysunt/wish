...
@Component({
  selector: 'app-myclosedactivities',
  templateUrl: './myclosedactivities.page.html',
  styleUrls: ['./myclosedactivities.page.scss'],
})
export class MyclosedactivitiesPage implements OnInit {
  mingci="五"
  isdianzan=false
      yikaishi=false
      weikaishi=true
    ...
    public jieshao = "活动是由共同目的联合起来并完成一定社会职能的动作的总和。活动由目的、动机和动作构成，具有完整的结构系统。苏联心理学家从20年代起就对活动进行了一系列研究。其中Α.Н.列昂节夫的活动理论对苏联心理学的发展影响很大，成为现代苏联心理学的重要理论基石。"
      ...
      back(){
        ...
        } else if(this.state=='myactivities'){
